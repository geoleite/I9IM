 ...
 * @author geoleite
 */
public class ImportacaoMercadorias2012_03_05 {
    ...
    public static void main(String[] param) {
        ImportacaoMercadorias2012_03_05 importacaoMercadorias = new ImportacaoMercadorias2012_03_05();
        ...
        if (linha != null && !linha.isEmpty()) {
            ...
            if (campos.length >= 3) {
                try {
                    ...
                    String[] dadosMercadoria = {codSap, codEstrutura, descMercadoria};
    ...
    private void lerArquivo() {
        try {
            properties.load(new FileInputStream("config_2012_03_05.properties"));
