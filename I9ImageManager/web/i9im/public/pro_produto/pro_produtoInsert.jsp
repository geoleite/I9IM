...
<form name="pro_produto" action="portal.jsp" method="post"   > 
    ...
    <input type="hidden" name="urlCanal" value="/i9im/public/pro_produto/pro_produtoInsert.jsp"/>
...
<table align="left" width="600" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    			    <input type="button" class="ms-ButtonHeightWidth" value="Cadastrar"  onClick="setOpPortal('pro_produto','insert', '/i9im/public/pro_produto/pro_produtoInsert.jsp')" /> &nbsp;&nbsp;
    			    <!--input type="reset"  value="Clear" onclick="setOpPortal('pro_produto','Limpar', '/i9im/public/pro_produto/pro_produtoInsert.jsp')"/-->&nbsp;&nbsp;
    			    <input type="button" class="ms-ButtonHeightWidth" value="Voltar"  onClick="setOpPortal('pro_produto','', '/i9im/public/pro_produto/pro_produtoConsult.jsp')" />
    </div></td>
  </tr>
</table>
<br/>
