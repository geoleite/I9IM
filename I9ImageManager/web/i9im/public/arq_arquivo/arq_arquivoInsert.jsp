...
<form name="arq_arquivo" action="portal.jsp" method="post" enctype="multipart/form-data" > 
    ...
    <input type="hidden" name="urlCanal" value="/i9im/public/arq_arquivo/arq_arquivoInsert.jsp"/>
    ...
    <table align="left" width="600" height="40" border="0" cellpadding="0" cellspacing="0">
        <tr >
            <td><div align="right">
                    <input type="button" class="ms-ButtonHeightWidth" value="Cadastrar"  onClick="setOpPortal('arq_arquivo','insert', '/i9im/public/arq_arquivo/arq_arquivoInsert.jsp')" /> &nbsp;&nbsp;
                    <!--input type="reset"  value="Clear" onclick="setOpPortal('arq_arquivo','Limpar', '/i9im/public/arq_arquivo/arq_arquivoInsert.jsp')"/-->&nbsp;&nbsp;
                    <input type="button" class="ms-ButtonHeightWidth" value="Voltar"  onClick="setOpPortal('arq_arquivo','', '/i9im/public/arq_arquivo/arq_arquivoConsult.jsp')" />
                </div></td>
        </tr>
    </table>
    <br/>
