 ...
 * @author ${user}
 */
public class RelatorioTotal extends Window implements Listener<ButtonEvent>, IListenetResponse {

    private LabelField lfTotalImagens = new LabelField();
    private Button btnFechar = new Button("Fechar");
    private String PAGE = "i9im/i9im/relatorio/relatorio.jsp?op=total";
