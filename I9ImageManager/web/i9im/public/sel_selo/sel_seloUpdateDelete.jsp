...
<form name="sel_selo" action="portal.jsp" method="post" enctype="multipart/form-data" >                                         
    ...
    <input type="hidden" name="urlCanal" value="/i9im/public/sel_selo/sel_seloUpdateDelete.jsp"/>
<!-- Titulo da Operacao-->
...
<table width="600" align="left" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    		<input type="button" value="Alterar" class="ms-ButtonHeightWidth" onClick="setOpPortal('sel_selo', 'update' , '/i9im/public/sel_selo/sel_seloUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Excluir" class="ms-ButtonHeightWidth" onClick="setOpPortal('sel_selo', 'delete' , '/i9im/public/sel_selo/sel_seloUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="Voltar" class="ms-ButtonHeightWidth" onClick="setOpPortal('sel_selo', 'consult', '/i9im/public/sel_selo/sel_seloConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<!--input type="button" value="Cancel" class="ms-ButtonHeightWidth"  onClick="setOpPortal('sel_selo', 'consult' , '/i9im/public/sel_selo/sel_seloConsult.jsp')" /-->
...
<br/>
	...
	<td class="ms-standardheader">
		sel_nr_id:<span class="style1">*</span>
	</td>
	<td class="ms-fields">
		<label class="ms-standardheader">
  		  <input type="text" name="sel_seloT.sel_nr_id" value="${sel_seloJB.sel_seloT.sel_nr_id}" onKeyPress="nextField(this, event)"/> 
   	       </label>
	</td>
     </tr>
<tr>
