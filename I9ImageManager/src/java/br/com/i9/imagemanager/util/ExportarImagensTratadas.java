 ...
 * @author geoleite
 */
public class ExportarImagensTratadas {

    public static void main(String[] param) {
        ThreadExportacaoSetor threadExportacao = new ThreadExportacaoSetor();
        threadExportacao.setSet_nr_id(Integer.parseInt(param[0]));
        threadExportacao.start();
        System.out.printf("Arquivo %1s salvo", "FIM");
    }
}

class ThreadExportacaoSetor extends Thread {
    ...
    private void salvar(String produto, String nomeArquivo, byte[] arquivo) throws Exception {
        String path = "/media/hd_externo2/arquivos_tratados";
    ...
    public void run() {
        ...
        try {
            ...
            List<Arq_arquivoT> lista = arqDao.getArquivosTratadosSetorSemImagemWeb(getSet_nr_id());
