...
import br.com.i9.imagemanager.gwt.client.model.*;
...
public class TestData {
  ...
  public static String[] getQuantidadesUpload() {
      return new String[] {
  ...
  public static List<QuantidadeUpload> getQuantidadeUploads() {
    List<QuantidadeUpload> quantidades = new ArrayList<QuantidadeUpload>();
    quantidades.add(new QuantidadeUpload("Um", 1));
    quantidades.add(new QuantidadeUpload("Dois", 2));
    quantidades.add(new QuantidadeUpload("Tres", 3));
    quantidades.add(new QuantidadeUpload("Quatro", 4));
    quantidades.add(new QuantidadeUpload("Cinco", 5));
    quantidades.add(new QuantidadeUpload("Seis", 6));
    quantidades.add(new QuantidadeUpload("Sete", 7));
    quantidades.add(new QuantidadeUpload("Oito", 8));
    quantidades.add(new QuantidadeUpload("Nove", 9));
    quantidades.add(new QuantidadeUpload("Dez", 10));
    return quantidades;
  }
