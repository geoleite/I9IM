...
<jsp:useBean id="set_setorJB" class="br.com.i9.imagemanager.jb.Set_setorConsultNewJB" scope="request"/>
...
<c:forEach items="${set_setorJB.list}" var="item">
 ...
 ,	"set_tx_status":"${item.set_tx_status}"
 ,	"set_nr_idsetorpai":"${item.set_nr_idsetorpai}"
 ,	"set_tx_visivel":"${item.set_tx_visivel}"
