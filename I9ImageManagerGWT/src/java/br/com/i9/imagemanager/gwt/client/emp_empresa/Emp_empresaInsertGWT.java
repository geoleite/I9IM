 ...
 * @author geoleite
 */
public class Emp_empresaInsertGWT extends CadastrarBaseGWT {
    ...
    public Emp_empresaInsertGWT() {
        setHeading("Cadastrar Empresa");
    ...
    public void btnInsertAction(ButtonEvent ce) {
        Emp_empresaTGWT emp_empresaT = new Emp_empresaTGWT();
        emp_empresaT.setEmp_tx_nome(emp_tx_nome.getValue());

        emp_empresaDao.inserir(emp_empresaT);
